...
export const timeStampGMTToHk = (timeStampGMT) => (timeStampGMT + (8 * 60 * 60 * 1000)); 

export const nowStr = (date, format, utc) => {
    return formatDate(new Date());
};

export const formatTimeStamp = (timestamp, format='YYMMDD-HHmmss', utc=false) => {
...
export const formatTimeStampHKStr = (timeStampGMT, format='YYYY-MM-DD HH:mm:ss') => {
    return formatDate(new Date(timeStampGMTToHk(timeStampGMT)), format, false);
};
export const formatDate = (date, format='YYMMDD-HHmmss', utc=false) => {
